    ...
    return (
      <div className="va-bg-dark-surface rounded-2xl p-6 border va-border-dark">
        ...
        <div className="flex items-center justify-center py-8">
          ...
          <span className="va-text-secondary">Loading server statistics...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="va-bg-dark-surface rounded-2xl p-6 border va-border-dark">
        ...
        <div className="flex items-center justify-center py-8">
          ...
          <div>
            <div className="va-text-primary font-medium">Server Unavailable</div>
            <div className="va-text-secondary text-sm">Unable to fetch server statistics</div>
          </div>
        </div>
      </div>
    );
